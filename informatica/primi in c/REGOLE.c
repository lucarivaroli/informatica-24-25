/*generato un valore, dire chi dei due si avvicina di piu */

k=rand()%9+0; //genera il numero casuale
printf("il valore di k e: \n", k);
...
if(scarto1<scarto2)
    ...
    printf("il numero che si avvicina di piu è %d", n2);
break;

/*contare e leggere le cifre di un numero*/
    q=numero
    if(q!=0)
        r=q%10;
        q=q/10;
